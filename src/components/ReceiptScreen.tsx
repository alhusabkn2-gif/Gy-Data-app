...
export default function ReceiptScreen({
  ...
  /* ---------------------------------------------------------------------- */
  /* CREATE PNG FROM THE ACTUAL RECEIPT                                    */
  /* ---------------------------------------------------------------------- */
  ...
  const shareReceipt = async () => {
    ...
    try {
       ...
       *
       * WhatsApp will receive the actual PNG file.
       */
      if (
        ...
        if (
          ...
          await navigator.share({
            ...
            text: 'GY DATA Transaction Receipt',
            files: [file],
          });
        ...
        /*
         * Browser supports Share but not file sharing.
         */
        await navigator.share({
          title: 'GY DATA Receipt',
          text: [
      ...
      /*
       * No native share available.
       * Download the same PNG instead.
       */
      const url =
        URL.createObjectURL(file);
      ...
      /*
       * User cancelled Android share sheet.
       */
      if (
