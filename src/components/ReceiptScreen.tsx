...
export default function ReceiptScreen({
  ...
  const shareReceipt = async () => {
    ...
    try {
      ...
      /*
       * Android / Chrome file sharing.
       *
       * This sends the actual PNG receipt.
       */
      if (
       ...
       * download the same PNG.
       */
      downloadFile(file);
    } catch (error: any) {
      /*
       * User closed the Android share sheet.
       */
      if (
