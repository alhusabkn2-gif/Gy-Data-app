          ...
          {quickActions.map((action) => {
            ...
            return (
              <motion.button
                ...
                whileTap={{ scale: 0.96 }}
                className="flex h-[58px] items-center justify-center gap-2 rounded-xl border border-[#18345f] bg-[#0b2147] px-2 shadow-sm transition-all hover:bg-[#102d5a] hover:shadow-md"
              >
